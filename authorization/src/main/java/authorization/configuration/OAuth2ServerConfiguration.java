...
import authorization.domain.token.TokenBlackListService;
...
class OAuth2ServerConfiguration extends AuthorizationServerConfigurerAdapter {
    private Logger logger = Logger.getLogger(OAuth2ServerConfiguration.class);
    ...
    public void configure(AuthorizationServerSecurityConfigurer oauthServer) throws Exception {
        oauthServer
                ...
                .tokenKeyAccess("hasAuthority('" + "ROLE_" + UserAuthorityType.ADMIN.toString() + "')")
                .checkTokenAccess("hasAuthority('" + "ROLE_" + UserAuthorityType.USER.toString() + "')");
    }
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients
                ...
                .authorities("ROLE_" + UserAuthorityType.ADMIN.toString())
                .scopes("read", "write")
                ...
                .authorities("ROLE_" + UserAuthorityType.USER.toString())
                .scopes("registerUser")
                .accessTokenValiditySeconds(10)
